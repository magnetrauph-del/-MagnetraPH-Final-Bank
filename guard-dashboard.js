// guard-dashboard.js V5 Final Sealed 20 Years - No Emoji - MagnetraPH - Dashboard Only
(function(){
"use strict";
...
for(var i=0;i<nodes.length;i++){var id=nodes[i].id;if(id==="card") hasCard=true;if(id==="CFG-DASHBOARD") hasCfg=true;}
