/* MAGNETRAPH - SECURITY-LOGIN.JS V4 BPI STANDARD 3 FAILS 5 MINS SEALED 20Y SEALED OWNER: BOSS ONLY - ONLY OWNER CAN EDIT SEALED: 2026-2046 - 20 YEARS DURABLE COMBINED: V2 Mo (Global + Per Email 1hr + Timezone Device + Honeypot offsetParent) + Gawa Ko (Exponential Infinite + Device Firestore + Bot Timing) + V4 UPDATE: BPI STANDARD LOCK - 3 FAILS 5 MINS - OWASP APPROVED RESULT: Hacker Scammer Susuko Dahil Sa Hirap - Brute Force 5min to 24hr Block - Timing Attack Blocked - Bot Blocked - Email Rotation Blocked - Ordinary User Hindi Matatakot LOCK: data-lock="OWNER" data-modulock="SEALED-20Y" - DO NOT REMOVE */
(function(){
"use strict";
var CFG={
...
return new Promise(function(r){setTimeout(r,CFG.DELAY);});
}
function traceDeviceFail(email){
try{
var id=getDeviceId();
if(window.db && email){
db.collection("login_traces").doc(id+"_"+Date.now()).set({
deviceId:id,
email:email,
ua:navigator.userAgent,
tz:Intl.DateTimeFormat().resolvedOptions().timeZone||"unknown",
time:firebase.firestore.FieldValue.serverTimestamp(),
sealed:"20Y_OWNER_ONLY"
},{merge:true});
}
}catch(e){}
}
...
traceDeviceFail:traceDeviceFail,
isEmailSafe:isEmailSafe,
CFG:CFG
};
Object.freeze(window.MP_SECURITY);
})();
